...
# TODO(danfm): Remove this condition once JAX 0.6.0 is released.
if ffi_lib:
...
def _buffer_callback_lowering(
  ...
  def wrapped_callback(exec_ctx: ExecutionContext, *args: Any):
  ...
  return ffi.ffi_lowering(target_name)(ctx, *args, index=index)
