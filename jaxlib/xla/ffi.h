...
class PyFfiAnyBuffer {
 public:
  PyFfiAnyBuffer(int32_t device_type, int32_t device_ordinal, void* data,
                 ffi::Span<int64_t const> dimensions,
                 ffi::DataType element_type);
  PyFfiAnyBuffer(int32_t device_type, int32_t device_ordinal,
                 ffi::AnyBuffer buf);
  PyFfiAnyBuffer(int32_t device_type, int32_t device_ordinal,
