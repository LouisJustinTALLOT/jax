...
// TODO(danfm): This is a copy of the same function in dlpack.cc. We can't
// include that here without introducing a circular dependency, but we should
// deduplicate.
absl::StatusOr<DLDataType> PrimitiveTypeToDLDataType(xla::PrimitiveType type) {
  switch (type) {
    case xla::S8:
...
// int32_t PyFfiContext::device_ordinal() const {
//   return api_->internal_api->XLA_FFI_INTERNAL_DeviceOrdinal_Get(ctx_);
// }

PyFfiAnyBuffer::PyFfiAnyBuffer(int32_t device_type, int32_t device_ordinal,
